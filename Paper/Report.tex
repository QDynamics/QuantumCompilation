...
\begin{frame}{generalized witness suite}
  ...
  \vspace{0.4em}
  \begin{itemize}
    \item 固定 $n=4$，不声称已经完成 width sweep
...
\begin{frame}{Synthesis of the Evidence}
  ...
  \begin{enumerate}
    ...
    \item canonical 和 generalized fixed-width Fourier experiments 实现 $\Omega(r)$ vs $O(1)$ 签名
...
\begin{frame}{最后收束}
  ...
  strict structural wins over \texttt{qiskit opt3} at $n=4$.
\end{frame}
